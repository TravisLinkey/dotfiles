...
__conda_setup="$('/home/travis/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/travis/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/travis/anaconda3/etc/profile.d/conda.sh"
    else
...
killProcess() {
  sudo lsof -t -i:"$1" | xargs -I{} sudo kill -9 {}
}
